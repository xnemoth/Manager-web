            ...
            <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0">
                <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 min-vh-100 vl">
                    <ul class="nav nav-pills flex-column align-items-center align-items-sm-start" id="sidebar">
                        ...
                        <li class="nav-item">
                            <a href="/homepage/admin/nhiemvu.php" class="nav-link align-middle px-0 active">
            ...
            <div class="col py-3">
                <div class="query-box">
                    <div class="form-floating mb-3 mt-3">
                        <input id="nvmnv" class="form-control query-info" type="text" name="nvmnv" placeholder=" " maxlength="2">
                        <label for="nvmnv" class="form-label">Loại nhiệm vụ</label>
                    </div>
                    <div class="form-floating mb-3 mt-3">
                        <input id="nvtnv" class="form-control query-info" type="text" name="nvtnv" placeholder=" " maxlength="20">
                        <label for="nvtnv" class="form-label">Tên nhiệm vụ</label>
                    </div>
                </div>
                <div class="query-btn">
        ...
        $(document).ready(function() {
            ...
            $("#delete").on("click", function() {
                $('#delete').html('Xoá').prop('disabled',
                    true);
                swal({
                        title: "Xóa dữ liệu nhiệm vụ này?",
                        text: "Lưu ý: Mọi dữ liệu liên quan đến công việc này phải được xóa trước!",
                        icon: "warning",
                        buttons: true,
                        dangerMode: true,
                    })
